...
group = "com.greenmiststudios.buddybuild"
version = "${project.properties["buddybuild.version_name"]?.toString()}-SNAPSHOT"
...
android {
  namespace = "com.greenmiststudios.buddybuild.common"
...
sqldelight {
  databases {
    create("Database") {
      packageName.set("com.greenmiststudios.buddybuild")
    }
    linkSqlite = true
  }
}